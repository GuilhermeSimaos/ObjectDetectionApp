...
function App(){
    ...
    const takePhoto = () => {
        ...
        canvas.toBlob((blob) => {
            ...
            axios.post('objdetectionserver-production.up.railway.app/post-photo', formData)
            .then((response) => {
    ...
    const getProcessedPhoto = () => {
        ...
        axios.get('objdetectionserver-production.up.railway.app/get-processed-photo', {responseType: 'blob'})
        .then(response => {
